...
export const createItemSchema = z.object({
  ...
  // .nullish() = string | null | undefined. Frontend mengirim `null` (bukan
  // undefined) untuk field opsional yang dikosongkan; kolomnya String? di DB,
  // jadi menulis null memang cara mengosongkannya. .optional() saja menolak null.
  ...
  confidential_level: z.enum(["high", "standard"]).nullish(),
